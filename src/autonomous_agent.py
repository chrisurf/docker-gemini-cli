...
async def process_task_file(self, file_path: str):
    ...
    try:
        ...
        logger.error("Error processing task file", 
...
async def _save_task_result(self, task_data: Dict[str, Any], 
                          result: Dict[str, Any], original_file: str):
